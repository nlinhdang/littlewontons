...
const OrderForm = ({ totalAmount, productList }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://api.allorigins.win/raw?url=" + encodeURIComponent("https://connect.pabbly.com/workflow/sendwebhookdata/IjU3NjYwNTZjMDYzNDA0MzM1MjY5NTUzNjUxMzYi_pc"), { //nlinhdang
